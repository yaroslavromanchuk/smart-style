...
<div class="col-xs-6">
   ...
   <div class="form-group field-credit-price">
<label class="control-label" for="credit-pric">Ціна авто</label>
<input type="number" id="credit-price"  class="form-control"  value="5000">
<input type="hidden" id="credit-month" class="form-control"  value="12">
<input type="hidden" id="credit-vnesok" class="form-control"  value="12">
<input type="hidden" id="credit-credit" class="form-control"  value="12">
<input type="hidden" id="amount" class="form-control"  >
<input type="hidden" id="credit-platij" class="form-control"  >
<input type="hidden" id="credit-stavka" class="form-control"  >
