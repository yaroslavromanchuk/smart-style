...
class CarsSearch extends Cars
{
    ...
    {
        return [
            [['id', 'year', 'price', 'currency_id', 'categories_id', 'brand_id', 'model_id', 'body_id', 'mileage', 'region_id', 'city_id', 'gearbox_id', 'drive_id', 'fuel_id', 'consumption_route', 'consumption_city', 'consumption_combine', 'power_hp', 'power_kw', 'color_id', 'metallic', 'post_auctions', 'doors', 'seats', 'country_id', 'spare_parts'], 'integer'],
            [['modification', 'image', 'damage', 'custom', 'VIN', 'video_key', 'description_ru', 'description_uk'], 'safe'],
            [['engine'], 'number'],
        ];
    }
