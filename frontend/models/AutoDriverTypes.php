...
/**
 * This is the model class for table "auto_driver_types".
 *
 * @property int $id
 ...
 * @property Cars[] $cars
 */
class AutoDriverTypes extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Cars::className(), ['drive_id' => 'id']);
    }
}
